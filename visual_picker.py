...
def on_date_selected(selected_date):
    ...
    date_to_pickle = selected_date
    with open("D:\\JOHN TILLET\\source\\active\\survey\\pickled_date", "wb") as f:
...
root.geometry("360x280+1000+450")
...
message_label = ttk.Label(
    mainframe,
    text="You can now restart the survey.",
)
message_label.grid(column=1, row=3, sticky=W)

close_button = tk.Button(mainframe, text="Restart", command=root.destroy)
